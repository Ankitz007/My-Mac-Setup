...
# time
function real_time() {
    local color="%{$fg_no_bold[black]%}";                    # color in PROMPT need format in %{XXX%} which is not same with echo
...
# login_info
function login_info() {
    local color="%{$fg_no_bold[green]%}";                    # color in PROMPT need format in %{XXX%} which is not same with echo
    local ip
